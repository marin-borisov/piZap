...
//  
//
//  Copyright (c) 2015 Martin Dimitrov. All rights reserved.
//
...
- (void)setupView
{
    ...
    switch (self.boxType) {
        ...
        case PlainTextInput:
            ...
            self.textInput.textAlignment = NSTextAlignmentLeft;//NSTextAlignmentCenter;
            if (self.customise) {
        ...
        case LoginAndPasswordInput:
            ...
            self.secureInput.textAlignment = NSTextAlignmentLeft;//NSTextAlignmentCenter;
            self.secureInput.tag = 200;
